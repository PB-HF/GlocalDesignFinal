/**
 * Footer — Optimized
 * SocialIcon moved outside component, no changes to styles/logic
 */
...
const Footer = () => (
  <footer className="bg-[#FAF8F5] pt-10 pb-0 relative z-30 overflow-hidden w-full">
    ...
    {/* Large bottom wordmark */}
    <div className="w-full flex justify-center overflow-hidden">
      <h1 className="font-['Lacroom'] text-[13vw] leading-none m-0 -mb-[2vw] whitespace-nowrap tracking-tight text-[#111]">
        GLOCAL DESIGN
      </h1>
    </div>
  </footer>
